    ...
    <div className="min-h-screen bg-study-break p-6 md:p-12 font-rounded overflow-x-hidden">
      ...
      <header className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 flex items-center justify-center gap-2">
          Molka <Sparkles className="w-8 h-8 text-yellow-400" />
        </h1>
      ...
      <main className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 relative z-10">
        ...
        <div className="md:col-span-2 bg-white/40 p-8 rounded-3xl border border-white/20 shadow-sm text-center space-y-6">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              onClick={onFinish}
              className="mt-4 bg-white/80 hover:bg-white px-8 py-4 rounded-full font-bold text-gray-700 shadow-lg transition-all flex items-center gap-2 group"
            >
              I'm ready to see it now <Heart className="w-4 h-4 text-red-400 group-hover:scale-125 transition-transform" />
            </button>
          </div>
        </div>
      </main>
            ...
            >
              ...
              <div className="relative z-10 pl-12 space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <button
                    onClick={handleYes}
                    className="flex-1 bg-[#ffb38e] hover:bg-[#ffa07a] text-white font-bold py-4 px-6 rounded-full shadow-lg transform hover:scale-105 transition-all flex items-center justify-center gap-2"
                  >
                  ...
                  {!actuallyYes ? (
                    ...
                    <button
                      onClick={handleYes}
                      className="flex-1 bg-[#ffd1dc] hover:bg-[#ffb6c1] text-gray-700 font-bold py-4 px-6 rounded-full shadow-lg transform hover:scale-105 transition-all animate-bounce"
                    >
                      Actually, yes ❤️
                    </button>
                  )}
